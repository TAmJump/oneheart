...
OUT = pathlib.Path("/mnt/user-data/outputs/ceo-final-yellow")
OUT.mkdir(parents=True, exist_ok=True)
BUILD = pathlib.Path("/home/claude/finalbuildy")
...
.num{flex:0 0 70px;height:70px;background:#111;color:#FFD900;
     font-family:'Inter';font-weight:900;font-size:40px;display:flex;
     align-items:center;justify-content:center;line-height:1}
.tt{flex:1}
h1{font-weight:900;letter-spacing:-.03em;line-height:1.16;font-size:54px;color:#111}
.deck{font-weight:700;line-height:1.65;margin-top:14px;font-size:20px;color:#1a1a1a}

.block{background:#111;color:#FFF8EC;padding:22px 24px;margin-top:14px}
.block h3{font-weight:900;font-size:27px;line-height:1.32;color:#FFD900}
...
.block li::before{content:"—";position:absolute;left:0;font-weight:900;color:#FFD900}

.accent{background:#111;color:#FFF8EC;padding:26px;margin-top:16px;
        font-weight:900;line-height:1.4;font-size:34px}
.accent .s{display:block;font-size:19px;font-weight:700;margin-top:12px;color:#FFD900}

.row{display:flex;gap:0;margin-top:14px;border:4px solid #111}
.row .c{flex:1;background:#FFD900;color:#111;padding:16px 10px;text-align:center;
...
.st{flex:1;background:#FFF8EC;color:#111;padding:16px 13px;border:4px solid #111}
...
.note{font-weight:400;font-size:15px;line-height:1.75;margin-top:14px;color:#1a1a1a}

.spacer{flex:1;min-height:12px}
.bar{display:flex;align-items:center;gap:20px;border-top:5px solid #111;
     margin-top:18px;padding-top:18px}
.bar .qr{flex:0 0 104px;border:4px solid #111;background:#fff;line-height:0}
.bar .id{flex:1;color:#111}
.bar .id .b{font-family:'Inter';font-weight:900;font-size:23px;line-height:1.05}
.bar .id .b small{display:block;font-size:11px;letter-spacing:.2em;margin-top:6px}
.bar .id .t{font-weight:700;font-size:14px;line-height:1.6;margin-top:9px}
.bar .kpi{display:flex;gap:10px}
.bar .kpi div{background:#111;color:#FFD900;padding:12px 14px;text-align:center;min-width:104px}
.bar .kpi .n{font-family:'Inter';font-weight:900;font-size:25px;line-height:1}
.bar .kpi .l{font-family:'Inter';font-weight:700;font-size:10px;letter-spacing:.14em;margin-top:6px}
.tag{font-family:'Inter';font-weight:900;font-size:15px;letter-spacing:.12em;
     margin-top:12px;text-align:right;color:#111}
"""
...
def p1():
    ...
    return head(1, "自分で生み出した<br>価値は、<span class=\"red\">自分のもの</span>だ。",
                "使い道も、自分で決めていい。") + f"""
<div class="block">
...
<div class="accent">自分の人生は、<span class="red">自分で決める</span>。
...
def p2():
    return head(2, "その選択肢は、<br><span class=\"red\">誰が</span>決めた？",
...
<div class="accent">選択肢は、与えられるものだけじゃない。
  <span class="s" style="font-size:34px;color:#E32219">自分でも、つくれる。</span></div>
""" + BAR


def p3():
    return head(3, "選べることも、<br><span class=\"red\">生きる力</span>になる。",
...
<div class="accent">命を支える。<br>その先の人生まで、<span class="red">本人が選べる</span>未来へ。</div>
""" + BAR


def p4():
    return head(4, "人間は、<br><span class=\"red\">2度</span>生まれる。",
...
def p5():
    return head(5, "君のアイデアが、<br>君の<span class=\"red\">未来</span>をつくる。",
...
<div class="accent">君は、支援されて終わらない。
  <span class="s" style="font-size:58px;font-weight:900;margin-top:14px;color:#FFD900">君が<span class="red">社長</span>だ。</span></div>
<div class="row">
...
PANELS = [
    {"id": "1", "bg": "#FFD900", "fg": "#111111", "fn": p1},
    {"id": "2", "bg": "#FFD900", "fg": "#111111", "fn": p2},
    {"id": "3", "bg": "#FFD900", "fg": "#111111", "fn": p3},
    {"id": "4", "bg": "#FFD900", "fg": "#111111", "fn": p4},
    {"id": "5", "bg": "#FFD900", "fg": "#111111", "fn": p5},
]
...
async def main():
    async with async_playwright() as pw:
        ...
        for p in PANELS:
            ...
            out = OUT / f"oneheart_yellow_{p['id']}_{W}x{H}.png"
